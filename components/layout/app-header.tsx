    ...
    <header className="flex h-[50px] items-center justify-between">
      <div className="flex items-center gap-2">
        <Image
          ...
          className="h-7 w-7"
        />
        <div className="text-[18px] font-semibold leading-6 tracking-[-0.04em] text-[var(--text-primary)]">
          <span>BitLedger </span>
      ...
      <div className="flex items-center gap-1">
        ...
        <IconButton className="overflow-visible">
          <Bell className="h-5 w-5 stroke-[1.9]" />
          <span className="absolute top-1 right-1 h-1.5 w-1.5 rounded-full bg-[var(--expense)]" />
        </IconButton>
        <button
          type="button"
          className="h-7 w-7 overflow-hidden rounded-full bg-[radial-gradient(circle_at_50%_30%,#65A8FF_0%,#2F6BFF_48%,#17338B_100%)] shadow-[0_7px_14px_rgba(47,107,255,0.14)]"
